...
const I18N = {
  en: {
    ...
    "details.orderNow": "Order Now via WhatsApp",
    "details.viewsToday": "🔥 {n} people viewed this today",
    "details.onlyXLeft": "Only {n} left in stock!",

    "reviews.eyebrow": "Reviews",
    "reviews.title": "Customer Reviews",
    "reviews.none": "No reviews yet — be the first!",
    "reviews.writeOne": "Write a Review",
    "reviews.namePlaceholder": "Your name",
    "reviews.commentPlaceholder": "What did you think? (optional)",
    "reviews.submit": "Submit Review",
    "reviews.needRatingAndName": "Please add a star rating and your name.",
    "reviews.submitted": "Thanks! Your review will show once it's approved.",
    "reviews.submitFailed": "Something went wrong — please try again.",
    ...
    "finder.title": "Find My Laptop",
    "finder.intro": "Answer a few quick questions and we'll suggest the laptops that actually fit what you need — no guesswork.",
    "finder.step": "Step {n} of {total}",
    "finder.back": "Back",
    "finder.next": "Next",
    "finder.seeResults": "See My Matches",
    "finder.startOver": "Start Over",

    "finder.q1.title": "What will you mainly use it for?",
    "finder.q2.title": "What's your budget?",
    "finder.q3.title": "New or used?",
    "finder.q4.title": "Any screen size preference?",

    "finder.usage.office": "Everyday Use & Browsing",
    "finder.usage.study": "Studying",
    "finder.usage.programming": "Programming & Dev Work",
    "finder.usage.gaming": "Gaming",
    "finder.usage.creative": "Photo & Video Editing",
    "finder.usage.heavy": "Heavy Multitasking & Pro Work",

    "finder.budget.any": "No preference",
    "finder.budget.b1": "Under 15,000 EGP",
    "finder.budget.b2": "15,000 – 25,000 EGP",
    "finder.budget.b3": "25,000 – 40,000 EGP",
    "finder.budget.b4": "40,000+ EGP",

    "finder.condition.any": "No preference",
    "finder.condition.new": "New only",
    "finder.condition.used": "Used only",

    "finder.screen.any": "No preference",
    "finder.screen.small": "Compact & portable (13–14\")",
    "finder.screen.medium": "Standard (15–16\")",
    "finder.screen.large": "Large (17\"+)",

    "finder.resultsTitle": "Your Best Matches",
    "finder.resultsSubtitle": "Based on your answers, here's what we'd recommend.",
    "finder.noMatches": "We don't have a close match in stock right now — try adjusting your answers, or contact us and we'll help you find one.",
    "finder.matchReason": "Good for:",
